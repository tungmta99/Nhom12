...
namespace QuanLyNhanSu2
{
    class Excel
    {
        public void KetXuat(DataTable dt,string SheetName, string title)
        {
            ...
            cl3.Value2 = "Mã loại bảo hiểm";
            cl3.ColumnWidth = 18.5;

            Microsoft.Office.Interop.Excel.Range cl4 = sheet.get_Range("D3", "D3");
            cl4.Value2 = "Loại bảo hiểm";
            cl4.ColumnWidth = 38.5;

            Microsoft.Office.Interop.Excel.Range cl5 = sheet.get_Range("E3", "E99");
            cl5.Value2 = "Ngày cấp";
            cl5.NumberFormat = "m/d/yyyy";
            cl5.ColumnWidth = 30.0;

            Microsoft.Office.Interop.Excel.Range cl6 = sheet.get_Range("F3", "F3");
            cl6.Value2 = "Nơi cấp";
            cl6.ColumnWidth = 50.5;
